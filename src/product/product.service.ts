...
import { productReturnObject, productReturnObjectFullest } from './objects/return-product.object';
...
export class ProductService {
    ...
    async getSimilar(id: number) {
        ...
        if(!currentProduct) throw new NotFoundException('Current product is not found')
